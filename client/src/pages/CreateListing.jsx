...
export default function CreateListing() {
  ...
  function handleChange(e) {
    ...
    if (type === "checkbox") {
      if (name === "sale" || name ==="rent") setFormData({ ...formData, ["type"]: name });
      else {
  ...
  return (
    <main className="p-3 max-w-7xl mx-auto">
      <h1 className="text-3xl text-center p-5 font-semibold">
        Create a Listing
      </h1>
          ...
          <div className="flex justify-evenly gap-4 flex-wrap">
            <div className="flex gap-3">
              <input
                ...
                className="w-6 "
              />
              <label htmlFor="sale" className="font-semibold">Sell</label>
            </div>
            <div className="flex gap-3">
              <input
                type="checkbox"
            ...
            <div className="flex gap-3">
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="parking" className="font-semibold">Parking spot</label>
            </div>
